...
<!--- 
importance d'expliciter la règle du jeu (exemple ds réunions règle du jeu implicite : ça dure plutôt autour d'une heure ou plus, ceux qui sont le plus extravertis monopolisent la parole, il n'y a généralement pas de rôle prédéfini à part parfois un animateur, on est généralement assis et autour d'une table, l'objectif est généralement aussi flou que les ingrédients. Tous ces éléments qui semblent naturels pourraient être requestionnés et il n'y a aucun obligation de les avoir, pourtant la plupart des réunions fonctionnent de cette manière comme si c'était une règle obligatoire).
...
---
 ...
 <!---
 Un événement peut être vu comme une sorte de jeu. Les règles commune régissent l’interaction et le fonctionnement du faire ensemble. C’est parce que chaque participant accepte qu’au football on ne peut pas toucher le ballon avec les mains (sauf exceptions très précises) que l’on peut jouer ensemble. 

Ce cadre permet ensuite de s’amuser ensemble.

Noter que formaliser avec des règles et un nom précis permet aussi d’avoir un vocabulaire commun. Ainsi quand je parle dis “vous voulez jouer au foot?” Tout le monde sait que je propose un jeu où on ne peut pas toucher le ballon avec les mains. 
...
--->
 ...
 <!--- si je vous parle d'une réunion, vous me comprenez à peu près, si je vous parle d'une réunion ou les participants sont assis en cercle ou seuls certains peuvent parler à certains moments prédéfinis, je devrais vous parler du format qui, ce qui prend un certain temps.
 
 si je ne dispose pas d'un mot pour cet ensemble de règles, ce jeu, alors je devrai chaque fois trouver un moyen de désigner ce format en particulier.
 
 Nommer avec un vocabulaire commun nous permettra alors de nous aligner plus facilement avec moins de bla bla.
 
 
 de tels événements sont nombreux, ils n'attendent qu'un vocabulaire commun pour se propager et bientôt il y aura des accents, et des argots puis des langues, mais au-dela des chapelles existantes (agilité, educ pop, ...)
 --->
 
 ---
 
 exemples événements avec recette
...
--->
 ...
 La même architecture est susceptible déclencher les mêmes résultats collectifs, peu importent les sujets, les défis, les places de marché et les acteurs qui sont en son centre. Une architecture différente peut augmenter ou réduire la cpacité d'une communauté à faire face à ces sujets donnés, défis, places de marché, acteurs. Les architectures influencent non seulement nos capacités, mais elles créent une nouvelle réalité (Noubel, J-F 2007)
...
<!---Connaissez-vous le mot libre ? Libre signifie “libre de droit”, c’est a dire que n’importe qui peut réutiliser et remodifier librement les contenus, à seule condition de citer la source et de ne pas remettre un copyright sur les travaux dérivés. En ayant à disposition des recettes libres on peut les partager, les améliorer, ...


Les recettes améliorées peuvent elles_mêmes être repartagées et ajoutées aux biens communs existants
...
--- 
# événement = Zone Autonome Temporaire

---
# Événement = bulle où on peut hacker ponctuellement la routine

---

# Réinventer nos façons de faire et vivre ensemble
...
![bg original]()
 ...
 - patterns comme outil de lecture des systèmes complexes
 ...
 ---
 # Trame
 donner envie, apprendre les bases, apprentissage avancé, au-delà de la maitrise (shu ha ri)
